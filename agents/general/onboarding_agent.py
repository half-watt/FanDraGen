...
class OnboardingAgent(BaseAgent):
    ...
    def execute(self, task: AgentTask, state: WorkflowState) -> AgentResult:
        ...
        scenario = read_json(league_data_path("season_context.json"))
        summary = "FanDraGen uses an NBA points-league setup with real player stats from the configured season CSV."
        rationale = [
        ...
        return AgentResult(
            ...
            rationale=rationale,
            assumptions=[
                "This explanation reflects local league_rules.json and season_context.json only.",
                "The scenario is set in the final week before fantasy playoffs.",
            ],
