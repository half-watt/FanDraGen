...
**Env (optional):** `GEMINI_API_KEY` for summary polish (`gemini_enrichment_applied` in payload). `FANDRAGEN_LIVE_ESPN=1` for ESPN headlines/standings enrichment alongside demo files.
